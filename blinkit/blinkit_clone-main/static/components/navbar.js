function navbar() {
  ...
  return ` <div id="mainNav">
    <div id="logo">
      <img 
        src="https://images.moneycontrol.com/static-mcnews/2022/01/pjimage-29-770x433.jpg?impolicy=website&width=770&height=431"
        alt=""
      />
    </div>
    <div id="location">
  ...
  <div id="sideCart">
    ...
    <div id="subcart">
      ...
      <p>from Super Store - chandigarh </p>
      <img
    ...
    <div id="bill">
      ...
      <button id="billed"> <a style="color:white;font-weight:bold" href="address"> proceed to pay </a></button>
    </div>
